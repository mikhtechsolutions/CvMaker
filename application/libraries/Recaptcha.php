...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_siteKey     = $this->_ci->general_settings['recaptcha_site_key'];
        $this->_secretKey   = $this->_ci->general_settings['recaptcha_secret_key'];
        $this->_language    = $this->_ci->general_settings['recaptcha_lang'];
    }
