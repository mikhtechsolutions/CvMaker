...
/**
 * Class Language
 * Primary objective of this class is to perform CRUD operations on DB in Language.
 */
class Language_model extends CI_Model
{
	 ...
	 * @return mixed
	 */
	function get_language_by_user_id($user_id, $order_by = null, $order = 'ASC', $active_flag = '')
	{
		$this->db->select();
	...
	{
		return $this->db->get_where('language', array(
			'id' => $id ,
