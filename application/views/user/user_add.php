  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; <?=trans('add_new_user')?></h4>
        </div>
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/users/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                <label for="address" class="col-sm-2 control-label"><?=trans('address')?></label>
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="<?=trans('add_user')?>" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
