    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('user/blog'); ?>" class="btn btn-success"><i class="fa fa-list"></i><?=trans('list_posts')?></a>
        </div>
      </div>
      </div>
    <div class="card">
      ...
      <div class="card-body">
        <div class="box-body">
          ...
          <?php echo form_open(base_url('user/blog/add_cat'), 'class="form-horizontal"');  ?>
          ...
          <?php $i=1; foreach ($cats as $cat): ?>
            <tr id="row_<?php echo html_escape($cat->id); ?>">
              ...
              <td class="actions" width="12%">
                <a title="<?=trans('edit')?>" class="update btn btn-sm btn-warning" href="<?php echo base_url('user/blog/edit_cat/'.html_escape($cat->id));?>"><i class="fa fa-pencil-square-o"></i></a>
                &nbsp;
                <a title="<?=trans('delete')?>" class="delete btn btn-sm btn-danger delete_item" data-link="<?=base_url('user/blog/delete_cat/'.html_escape($cat->id));?>" data-id="<?php echo html_escape($cat->id); ?>" href="#exampleModal" data-toggle="modal" data-placement="top" data-target="#exampleModal"> <i class="fa fa-trash-o"></i></a>
                &nbsp;
              </td>
            </tr>
