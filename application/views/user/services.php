        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-inline-block float-right">
                    <a href="<?= base_url('user/services/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?=trans('add_new_service')?></a>
                </div>
            </div>
            <!-- /.card-header -->
        </div>
                    ...
                    <tbody>
                        ...
                        <tr id="row_<?php echo html_escape($service->id); ?>">
                            ...
                            <td class="actions" width="12%">
                                <a title="<?=trans('edit')?>" class="update btn btn-sm btn-warning" href="<?php echo base_url('user/services/edit/'.html_escape($service->id));?>"><i class="fa fa-pencil-square-o"></i></a>
                                &nbsp;
                                <a title="<?=trans('delete')?>" class="delete btn btn-sm btn-danger delete_item" data-link="<?=base_url('user/services/delete/'.html_escape($service->id));?>" data-id="<?php echo html_escape($service->id); ?>" href="#exampleModal" data-toggle="modal" data-placement="top" data-target="#exampleModal"> <i class="fa fa-trash-o"></i></a>
                                &nbsp;
                            </td>
                        </tr>
