    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('admin/services'); ?>" class="btn btn-success"><i class="fa fa-list"></i><?=trans('list_services')?></a>
        </div>
      </div>
      <!-- /.card-header -->
    </div>
    <div class="card">
      <div class="card-body">
        <div class="box-body">
          ...
          <?php echo form_open_multipart(base_url('admin/services/add'), 'class="form-horizontal"');  ?>
          ...
          <div class="row form-group">
            <div class="col-6">
              <label for="exampleInputFile"><?=trans('service_image')?><?=IMAGE_FILE_TYPES?></label>
          ...
          if (isset($update_id)):
            ...
            <div class="row form-group">
              <div class="col-12">
                <input type="submit" name="submit" value="<?=$btn_save.' Service';?>" class="btn btn-info pull-right">
              </div>
            </div>
            <?php echo form_close(); ?>
          </div>
