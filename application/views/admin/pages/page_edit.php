            ...
            <div class="box border-top-solid">
              ...
              <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/pages/edit/'.$page['id']), 'class="form-horizontal"');  ?> 
                    ...
                    <div class="form-group">
                      <label for="name" class="col-sm-3 control-label"><?= trans('status') ?></label>
                      <div class="col-sm-12">
                        <?php 
                        $options =array('1' => trans('active'), '0' => trans('deactive')); 
                        echo form_dropdown('status',$options,$page['is_active'],'class="form-control"');
                        ?>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <input type="submit" name="submit" value="<?= trans('update_page') ?>" class="btn btn-primary pull-right">
                      </div>
                    </div>
                  <?php echo form_close( ); ?>
                </div>
