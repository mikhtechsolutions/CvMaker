...
class Services extends MY_Controller
{
    ...
    function index($type='')
    {
        ...
        $data['title'] = trans('user_services');
    ...
    public function add(){
        ...
        if($this->input->post('submit')){
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect(base_url('user/services/add'),'refresh');
            } else {
                $data = array(
                    'user_id' => $user_id,
                ...
                if ($update_id && !$insert_id) {
                    redirect(base_url('user/services/edit/'.$update_id),'refresh');
                    exit;
                } else if ($insert_id){
            ...
            $this->load->view('admin/includes/_header', $data);
            $this->load->view('user/service_add');
            $this->load->view('admin/includes/_footer', $data);
        }
    }
